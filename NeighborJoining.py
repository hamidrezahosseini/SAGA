...
class NeighborJoining():
	...
	def execute(self):
		...
		'''
		self.d = [
			[0.00, 30.90, 25.50, 27.35, 27.55, 24.35, 37.70], #T.celer
			[30.90, 0.00, 36.85, 36.25, 37.80, 17.05, 37.75], #E.coli
			[25.50, 36.85, 0.00, 5.40, 5.15, 33.45, 26.80],   #M.musculus
			[27.35, 36.25, 5.40, 0.00, 7.35, 34.50, 27.95],   #G.gallus
			[27.55, 37.80, 5.15, 7.35, 0.00, 34.10, 28.80],   #X.laevis
			[24.35, 17.05, 33.45, 34.50, 34.10, 0.00, 36.15], #B.subtilis
			[37.70, 37.75, 26.8, 27.95, 28.80, 36.15, 0.00]   #C.albicans	
		]
		'''
		print(self.d)
		#self.labels = ["'T.celer'", "'E.coli'", "'M.musculus'", "'G.gallus'", "'X.laevis'", "'B.subtilis'", "'C.albicans'"]
